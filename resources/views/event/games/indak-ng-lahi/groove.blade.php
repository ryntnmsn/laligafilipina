    ...
    <div class="flex flex-col">
        ...
        <div class="mt-10">
            <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove1.jpg') }}">
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove2.jpg') }}">
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove3.jpg') }}">
            </div>
       </div>
