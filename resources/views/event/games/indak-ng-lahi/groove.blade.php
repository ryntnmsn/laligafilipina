...
@section('contents')
    <div class="flex flex-col">
        ...
        <div class="w-full text-center mt-10">
            <h1 class="text-5xl">Groove Force</h1>
        </div>
        ...
        <div class="mt-10">
            <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove1.jpg') }}" loading='lazy'>
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove2.jpg') }}" loading='lazy'>
                <img src="{{ url('images/games/indak-ng-lahi/groove/groove3.jpg') }}" loading='lazy'>
            </div>
       </div>
