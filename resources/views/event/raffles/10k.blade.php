    ...
    <div class="flex flex-col">
        ...
        <div class="mt-10">
            <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <img src="{{ url('images/raffles/10k/10k1.jpg') }}" loading='lazy'>
                <img src="{{ url('images/raffles/10k/10k2.jpg') }}" loading='lazy'>
                <img src="{{ url('images/raffles/10k/10k3.jpg') }}" loading='lazy'>
            </div>
       </div>
